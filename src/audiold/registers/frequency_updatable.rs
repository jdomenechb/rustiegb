...
pub trait FrequencyUpdatable {
    ...
    fn set_freq_high_part_from_register(&mut self, register: Byte) {
    ...
    fn set_freq_low_part_from_register(&mut self, register: Byte) {
...
pub trait FrequencyRegisterUpdatable: FrequencyUpdatable {
    fn trigger_frequency_register_update(&mut self, register: Byte) {
        self.set_freq_low_part_from_register(register);
    }
}
